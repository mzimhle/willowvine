	...
	<!-- ending of footnav -->
			<div style="display: none;" class="lightbox" id="lightbox_login">
				<div style="display: block;" id="lightboxLoginFormDiv">
					...
					<form id="lightboxLoginForm" name="lightboxLoginForm" method="post" action="{$currentLink|default:"/"}" enctype="multipart/form-data" >
				...
				<div style="display: none;" id="lightboxForgottenPasswordFormDiv">
					<div id="side_box" class="myform">
						<form id="lightboxLoginForgottenPasswordForm" name="lightboxLoginForgottenPasswordForm" method="post" action="{$currentLink|default:"/"}" enctype="multipart/form-data" >
							<a class="standard_blue_btn fr" href="JavaScript:$.modal.close();">
								<span id="close">Close</span>								
							</a>					
