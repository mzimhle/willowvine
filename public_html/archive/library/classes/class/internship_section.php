...
class class_internship_section extends Zend_Db_Table_Abstract
{
   //declare table variables
    protected $_name = 'internship_section';
	 ...
	 */
	 public function sectionPairs() {
		$select = $this->select()
					   ->from(array('a' => 'internship_section'), array('a.pk_section_id', 'a.section_name'))
					   ->where('section_active = 1 AND section_deleted = 0')
