...
class class_career_section extends Zend_Db_Table_Abstract
{
   //declare table variables
    protected $_name = 'career_section';
	 ...
	 */
	 public function sectionPairs() {
		$select = $this->select()
					   ->from(array('a' => 'career_section'), array('a.pk_section_id', 'a.section_name'))
					   ->where('section_active = 1 AND section_deleted = 0')
