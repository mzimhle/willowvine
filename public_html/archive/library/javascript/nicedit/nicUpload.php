...
define('NICUPLOAD_PATH', $_SERVER['DOCUMENT_ROOT'].'/media/pages'); // Set the path (relative or absolute) to
                                      // the directory to save image files
                                      
define('NICUPLOAD_URI', '/media/pages');   // Set the URL (relative or absolute) to
