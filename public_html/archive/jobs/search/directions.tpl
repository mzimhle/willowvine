...
<div id="container">
	...
	<br />
	<a class="standard_blue_btn fr" title="Go back to your search results" href="/jobs/search/{$jobData.section_urlName}/details/{$jobData.job_link}/{$jobData.job_reference}/?page={$page}{if $searchJob neq ''}&searchJob={$searchJob}{/if}{if $sectionId neq ''}&sectionId={$sectionId}{/if}{if $type neq ''}&type={$type}{/if}{if $area neq ''}&area={$area}{/if}">
