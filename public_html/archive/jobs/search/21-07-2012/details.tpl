...
<div id="container">
	...
	<a class="standard_blue_btn fr" title="Go back to your search results" href="/jobs/search/?searchJob={$searchJob}&sectionId={$sectionId}&page={$page}">
	...
	<div class="left_content">
			...
			<div class="map_image_container">
				<a href="/jobs/search/{$jobData.section_urlName}/directions/{$jobData.job_link}/{$jobData.job_reference}/?searchJob={$searchJob}&page={$page}">
