...
<head>
<title>Ref. {$jobData.job_reference}, {$jobData.job_title}, {$jobData.section_name}, jobs in {$jobData.job_area}</title>
<meta name="description" content="Find a Job Advert - {$jobData.job_title}, {$jobData.section_name}, jobs in {$jobData.job_area}, reference: {$jobData.job_reference}">
...
<div id="container">
	...
	<div id="contnav" class="fl">
		<p class="fl">
			...
			<span>|</span> &nbsp; 
			<span>Found this job, <span class="green_text">{$jobData.job_title}</span> in <span class="green_text">{$jobData.job_area}</span></span>		
	...
	<a class="standard_blue_btn fr" title="Go back to your search results" href="/jobs/search/?searchJob={$searchJob}&searchArea={$searchArea}&sectionId={$sectionId}&page={$page}">
	...
	<div class="right_content">
			...
			<div class="description_links">
				<ul>
					<li><a title="View {$jobData.section_name} jobs" href="/jobs/search/?sectionId={$jobData.pk_section_id}">View {$jobData.section_name} jobs</a></li>
					<li><a title="View {$jobData.job_title} jobs" href="/jobs/search/?searchJob={$jobData.job_title}">View "{$jobData.job_title}" jobs</a></li>
					<li><a title="View Jobs in {$jobData.job_area}" href="/jobs/search/?searchArea={$jobData.job_area}">View Jobs in "{$jobData.job_area}"</a></li>
				</ul>
			</div>			
			<div class="clear"></div>
