...
<head>
<title>Ref. {$jobData.job_reference}, {$jobData.job_title}, {$jobData.section_name}, jobs in {$jobData.job_area}{if $page neq ''}, "" {$page}{/if}</title>
...
<div id="container">
	...
	<div class="left_content">
			...
			<div class="map_image_container">
				<a href="/jobs/search/{$jobData.section_urlName}/directions/{$jobData.job_link}/{$jobData.job_reference}/">
