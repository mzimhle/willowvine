...
<div id="container">
	...
	<a class="standard_blue_btn fr" title="Go back to your search results" href="/jobs/search/{$jobData.section_urlName}/details/{$jobData.job_link}/{$jobData.job_reference}/?searchJob={$searchJob}&searchArea={$searchArea}&page={$page}">
