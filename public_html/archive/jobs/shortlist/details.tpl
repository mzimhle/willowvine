...
<head>
<title>Shortlisted Ref. {$jobData.job_reference}, {$jobData.job_title}, {$jobData.section_name}, jobs in {$jobData.job_area}{if $page neq ''}, on page {$page}{/if}</title>
<meta name="description" content="Shortlist Ref. {$jobData.job_reference}, {$jobData.job_title}, {$jobData.section_name}, jobs in {$jobData.job_area}{if $page neq ''}, "" {$page}{/if}">
...
<div id="container">
	...
	<br />
	<a class="standard_blue_btn fr" title="Go back to shortlist" href="/jobs/shortlist/?page={$page}">
	...
	<div class="left_content width760">
			...
			<div class="map_image_container">
				<a href="/jobs/shortlist/{$jobData.section_urlName}/directions/{$jobData.job_link}/{$jobData.job_reference}/?page={$page}">
