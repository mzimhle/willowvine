...
{if $jobItems|@count gt 0}		
	...
	<div class="search_item search_odd_{if $smarty.foreach.foo.index is even}blue{else}dark{/if}">
		<div class="title_box">
			<a style="color: #063166;" title="View this job, {$item.job_title|normal_text}'s details" href="/jobs/shortlist/{$item.section_urlName}/details/{$item.job_link}/{$item.job_reference}/?page={$paginator->current}" style="text-decoration: none;">
