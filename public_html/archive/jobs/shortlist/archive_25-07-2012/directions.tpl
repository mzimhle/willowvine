...
<div id="container">
	...
	<a class="standard_blue_btn fr" title="Go back to your search results" href="/jobs/shortlist/{$jobData.section_urlName}/details/{$jobData.job_link}/{$jobData.job_reference}/?searchJob={$searchJob}&searchArea={$searchArea}&page={$page}">
		<span id="Login">Back to your job</span>								
	</a>
	<p><span class="blue_text">{$jobData.job_area}</span></p>
	<div class="clear"></div>
