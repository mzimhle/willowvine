...
<head>
<title>Shortlisted Ref. {$jobData.job_reference}, directions for {$jobData.job_title}, {$jobData.section_name}, jobs in {$jobData.job_area}</title>
<meta name="description" content="Shortlisted Directions for {$jobData.job_title}, {$jobData.section_name}, jobs in {$jobData.job_area}, reference: {$jobData.job_reference}">
...
<div id="container">
	...
	<br />
	<a class="standard_blue_btn fr" title="Go back to shortlist" href="/jobs/shortlist/{$jobData.section_urlName}/details/{$jobData.job_link}/{$jobData.job_reference}/?page={$page}">
		<span id="Login">Back to your shortlisted job</span>								
	</a>	
