...
<div id="container">
	...
	<div class="left_content" style="width: 545px;">
		...
		<label>Job Area/Town<img src="/images/required_dot.png" style="margin-bottom: 7px;" /><span class="small" {if isset($errorMessages.areaMap_path)}style="color: red;font-weight: bold;"{/if}>{$errorMessages.areaMap_path|default:"Where do you live"}</span></label>
