...
<div id="container">
	...
	<span class="blue_text font_16">{$internshipData.section_name}</span><br>
	<span class="font_16">{$internshipData.internship_area}</span>
	...
	<div class="left_content width760">
			...
			<br>
			<p>
				{if $internshipData.internship_company neq ''}<span class="blue_text font_16">Company/Organization:</span><br><span class="font_16">{$internshipData.internship_company}</span><br><br>{/if}
				{if $internshipData.internship_contact_name neq ''}<span class="blue_text font_16">Contact Email:</span><br><span class="font_16">{$internshipData.internship_contact_name}</span><br><br>{/if}
				{if $internshipData.internship_contact_email neq ''}<span class="blue_text font_16">Contact Email:</span><br><span class="font_16">{$internshipData.internship_contact_email}</span><br><br>{/if}
				{if $internshipData.internship_contact_number neq ''}<span class="blue_text font_16">Contact Number/s:</span><br><span class="font_16">{$internshipData.internship_contact_number}</span><br><br>{/if}			
			</p>				
