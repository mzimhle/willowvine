<?php /* Smarty version 2.6.20, created on 2014-12-03 18:43:44
         compiled from admin/resources/careers/contact.tpl */ ?>
...
<?php else: ?>#<?php endif; ?>" title="Education">Education</a></li>
	...
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/admin/resources/careers/contact.php<?php if (isset ( $this->_tpl_vars['careerData']['pk_career_id'] )): ?>?pk_career_id=<?php echo $this->_tpl_vars['careerData']['pk_career_id']; ?>
...
/" target="_blank">View career On site</a>
		...
		<?php endif; ?>		  	  		  		  
		  <tr>
            <td class="left_col" valign="top" <?php if (isset ( $this->_tpl_vars['errorArray']['career_contact'] )): ?>style="color: red"<?php endif; ?>><h4>Contact:</h4></td>
            <td>
				<textarea name="career_contact" id="career_contact" style="width: 600px; height: 300px;"><?php echo $this->_tpl_vars['careerData']['career_contact']; ?>
</textarea>
          </tr>			  
        </table>
      </form>
