<?php /* Smarty version 2.6.20, created on 2015-02-01 12:28:06
         compiled from admin/users/jobSeekers/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/users/jobSeekers/default.tpl', 50, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><?php echo $this->_tpl_vars['siteName']; ?>
 | Users | jobSeekers</title>
	...
	<div class="content_table">
		...
		<table id="dataTable" border="0" cellspacing="0" cellpadding="0">
		  <thead>
		   ...
		   <tbody>
		  <?php $_from = $this->_tpl_vars['jobSeekerData']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
