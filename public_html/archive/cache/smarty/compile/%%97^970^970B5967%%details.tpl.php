<?php /* Smarty version 2.6.20, created on 2015-01-26 17:00:12
         compiled from jobs/shortlist/details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'normal_text', 'jobs/shortlist/details.tpl', 33, false),array('modifier', 'trim', 'jobs/shortlist/details.tpl', 42, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Shortlisted Ref. <?php echo $this->_tpl_vars['jobData']['job_reference']; ?>
...
<?php endif; ?></title>
<meta name="description" content="Shortlist Ref. <?php echo $this->_tpl_vars['jobData']['job_reference']; ?>
, <?php echo $this->_tpl_vars['jobData']['job_title']; ?>
, <?php echo $this->_tpl_vars['jobData']['section_name']; ?>
, jobs in <?php echo $this->_tpl_vars['jobData']['job_area']; ?>
...
smarty_core_smarty_include_php(array('smarty_file' => "includes/search_jobs.php", 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<br />
	<a class="standard_blue_btn fr" title="Go back to shortlist" href="/jobs/shortlist/?page=<?php echo $this->_tpl_vars['page']; ?>
">
		<span id="Login">Back to shortlist</span>								
	</a>		
	<h1>
		<?php echo $this->_tpl_vars['jobData']['job_title']; ?>
...
", <?php echo $this->_tpl_vars['jobData']['job_reference']; ?>
					...
					<li><a class="small_blue_bg_dark_btn fr" title="Remove from shortlist" alt="Remove from shortlist" href="<?php if ($this->_tpl_vars['jobData']['shortlist'] == 0): ?>/jobs/shortlist/<?php else: ?>Javascript:shortListRemove(<?php echo $this->_tpl_vars['jobData']['job_reference']; ?>
);<?php endif; ?>"><span id="share_job"><?php if ($this->_tpl_vars['jobData']['shortlist'] == 0): ?>View shortlist<?php else: ?>Remove from shortlist<?php endif; ?> (<?php echo $this->_tpl_vars['jobShareCount']; ?>
)</span></a></li>						
				</ul>
			</div>
			<div class="clear"></div>
			...
			<div class="map_image_container">
				<a href="/jobs/shortlist/<?php echo $this->_tpl_vars['jobData']['section_urlName']; ?>
