<?php /* Smarty version 2.6.20, created on 2013-11-03 17:08:14
         compiled from admin/resources/internshipShare/internshipShareHtml.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/resources/internshipShare/internshipShareHtml.tpl', 15, false),)), $this); ?>
<!-- Start Content Table -->
<div class="content_table">
    ...
    <table id="grid_table" border="0" cellspacing="0" cellpadding="0">
      ...
      <?php $_from = $this->_tpl_vars['internshipShareItems']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?>
      <tr>
        <td><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['internshipShare_added'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</td>
        <td align="left"><a href="http://www.willowvine.co.za/internships/<?php echo $this->_tpl_vars['item']['section_urlName']; ?>
/details/<?php echo $this->_tpl_vars['item']['internship_link']; ?>
/<?php echo $this->_tpl_vars['item']['pk_internship_id']; ?>
/" target="_blank"><?php echo $this->_tpl_vars['item']['internship_title']; ?>
</a></td>	
		<td align="left"><?php echo $this->_tpl_vars['item']['internshipShare_name']; ?>
 (<?php echo $this->_tpl_vars['item']['internshipShare_email']; ?>
)</td>
		<td align="left"><?php echo $this->_tpl_vars['item']['internshipShare_friendName']; ?>
 (<?php echo $this->_tpl_vars['item']['internshipShare_friendEmail']; ?>
)</td>
		<td align="left"><?php echo $this->_tpl_vars['item']['internship_area']; ?>
</td>		
      </tr>
      <?php endforeach; else: ?>
    	<tr>
