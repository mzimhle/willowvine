...
<script type="text/javascript" language="javascript" src="/admin/resources/careers/default.js"></script>
</head>
...
smarty_core_smarty_include_php(array('smarty_file' => 'admin/includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/admin/resources/careers/" title="View Jobs">Careers</a></li>
        </ul>
	</div><!--breadcrumb-->  
	<div class="inner">     
    <h2>Manage Careers</h2>		
	<h4>Manage all the careers in the database, view and edit them at will.</h4>	
	<a href="/admin/resources/careers/details.php" title="Click to Add a new career" class="blue_button fr mrg_bot_10"><span style="float:right;">Add a new career</span></a> <br />
