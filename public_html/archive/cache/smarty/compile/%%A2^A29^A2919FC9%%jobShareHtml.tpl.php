<?php /* Smarty version 2.6.20, created on 2013-11-21 09:11:38
         compiled from admin/resources/jobShare/jobShareHtml.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/resources/jobShare/jobShareHtml.tpl', 15, false),)), $this); ?>
<!-- Start Content Table -->
<div class="content_table">
    ...
    <table id="grid_table" border="0" cellspacing="0" cellpadding="0">
      ...
      <?php $_from = $this->_tpl_vars['jobShareItems']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
?>
      <tr>
        ...
        <td align="left"><a href="http://www.willowvine.co.za/jobs/search/<?php echo $this->_tpl_vars['item']['section_urlName']; ?>
/details/<?php echo $this->_tpl_vars['item']['job_link']; ?>
/<?php echo $this->_tpl_vars['item']['job_reference']; ?>
/" target="_blank"><?php echo $this->_tpl_vars['item']['job_title']; ?>
</a></td>	
		<td align="left"><?php echo $this->_tpl_vars['item']['jobShare_name']; ?>
 ...
 (<?php echo $this->_tpl_vars['item']['jobShare_friendEmail']; ?>
		...
		<td align="left"><?php echo $this->_tpl_vars['item']['job_area']; ?>
</td>		
      </tr>
      <?php endforeach; else: ?>
    	<tr>
