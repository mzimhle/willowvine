...
<div id="container">
  ...
  <div id="content">
    ...
    <div id="sidetabs">
        <ul > 
            <li><a href="/admin/jobs/view/details.php?pk_job_id={$jobData.pk_job_id}" title="Details">Details</a></li>
			<li class="active"><a href="#" title="Details">Page</a></li>
        </ul>
    </div><!--tabs-->

	<div class="detail_box">
      <form id="pageForm" name="pageForm" action="/admin/jobs/view/page.php{if isset($jobData.pk_job_id)}?pk_job_id={$jobData.pk_job_id}{/if}" method="post">
