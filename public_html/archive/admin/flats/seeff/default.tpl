...
<title>{$siteName} | Flats</title>
{include_php file='admin/includes/css.php'}
{include_php file='admin/includes/javascript.php'}
<script type="text/javascript" language="javascript" src="/admin/flats/seeff/default.js"></script>
</head>
...
<div id="container">
  ...
  <div id="content">
	...
	<div class="inner">     
    <h2>Manage Seeff Flats</h2>
	<p>Select section and add accordingly. </p>	
	<a href="/admin/flats/seeff/getFromSeeff.php" target="_blank" title="Get All Flats From Seeff" class="blue_button fr mrg_bot_10"><span style="float:right;">Get All Flats From Seeff</span></a>
