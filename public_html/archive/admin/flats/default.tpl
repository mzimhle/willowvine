    ...
    <div class="logged_in">
  	...
  	<br />
        ...
        <ul>
            ...
            <li><a href="/admin/resources/" title="Resources">Flats</a></li>
        </ul>
	</div><!--breadcrumb-->  
  <div class="inner">  
   <h2>Manage Flats to Rent</h2>	
	  ...
	  <div class="section">
		<a href="/admin/flats/seeff/" title="Manage Seeff Flats"><img src="/admin/images/users.gif" alt="Manage Areas" height="50" width="50" /></a>
		<a href="/admin/flats/seeff/" title="Manage Seeff Flats" class="title">Manage Seeff Flats</a>
	  </div><!--
