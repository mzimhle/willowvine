...
<div id="container">
  ...
  <div id="content">
	...
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/admin/resources/careers/education.php{if isset($careerData.pk_career_id)}?pk_career_id={$careerData.pk_career_id}{/if}" method="post">
		...
		{/if}		  	  		  		  
		  <tr>
            <td class="left_col" valign="top" {if isset($errorArray.career_education)}style="color: red"{/if}><h4>Education:</h4></td>
            <td>
				<textarea name="career_education" id="career_education" style="width: 600px; height: 800px;">{$careerData.career_education}</textarea>
			</td>
          </tr>			  
        </table>
      </form>
