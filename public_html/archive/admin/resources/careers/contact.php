...
if(count($_POST) > 0) {
	...
	if(isset($_POST['career_contact']) && trim($_POST['career_contact']) == '') {
		$errorArray['career_contact'] = 'required';
		$formValid = false;		
	}	
	...
	if(count($errorArray) == 0 && $formValid == true) {
		...
		if(is_numeric($success) && $success > 0) {							
			header('Location: /admin/resources/careers/details.php?pk_career_id='.$careerId);				
			exit;		
		}
...
$smarty->display('admin/resources/careers/contact.tpl');
