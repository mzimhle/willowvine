...
<script type="text/javascript" language="javascript" src="/admin/sections/default.js"></script>
</head>
...
<div id="container">
  ...
  <div id="content">
	...
	<a href="/admin/sections/details.php" title="Click to Add a new Area" class="blue_button fr mrg_bot_10"><span style="float:right;">Add a new Section</span></a> <br />
