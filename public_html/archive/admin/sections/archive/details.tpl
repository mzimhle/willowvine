  ...
  <div id="content">
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/admin/sections/" title="sections">Sections</a></li>
	...
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/admin/sections/details.php{if isset($sectionData.pk_section_id)}?sectionId={$sectionData.pk_section_id}{/if}" method="post">
