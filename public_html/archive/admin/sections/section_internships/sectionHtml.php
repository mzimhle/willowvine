...
$sectionData = $sectionObject->getPaginatedsection('internship_section.section_added != ""','internship_section.section_name ASC', $currentPage, $perPage, $listedPages, $scrollingStyle);
...
/* 
	display template
*/
$smarty->display('admin/sections/section_internships/sectionHtml.tpl');
