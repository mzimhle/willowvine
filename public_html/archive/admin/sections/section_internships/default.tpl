...
<script type="text/javascript" language="javascript" src="/admin/sections/section_internships/default.js"></script>
</head>
  ...
  <div id="content">
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/admin/sections/section_internships/" title="Jobs">Internship Sections</a></li>
        </ul>
	</div><!--breadcrumb-->  
	<div class="inner">     
    <h2>Manage Sections</h2>
	<p>Select section and add accordingly. </p>
	<a href="/admin/sections/section_internships/details.php" title="Click to Add a new Area" class="blue_button fr mrg_bot_10"><span style="float:right;">Add a new Section</span></a> <br />
