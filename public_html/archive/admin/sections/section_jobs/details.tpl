...
<div id="container">
  ...
  <div id="content">
	...
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/admin/sections/section_jobs/details.php{if isset($sectionData.pk_section_id)}?sectionId={$sectionData.pk_section_id}{/if}" method="post">
