<?php /* Smarty version 2.6.20, created on 2015-07-21 08:38:57
         compiled from participants/view/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'participants/view/default.tpl', 43, false),)), $this); ?>
...
?>
			  <tr>
				...
				<td align="left">
					<a href="/participants/view/details.php?code=<?php echo $this->_tpl_vars['item']['participant_code']; ?>
" class="<?php if ($this->_tpl_vars['item']['participant_active'] == 1): ?>success<?php else: ?>error<?php endif; ?>">
 ...
 <?php echo $this->_tpl_vars['item']['participant_surname']; ?>
				...
				<td align="left"><button onclick="changestatus('<?php echo $this->_tpl_vars['item']['participant_code']; ?>
', '<?php echo $this->_tpl_vars['item']['participant_active']; ?>
