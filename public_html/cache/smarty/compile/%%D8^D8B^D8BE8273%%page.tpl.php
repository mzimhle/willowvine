<?php /* Smarty version 2.6.20, created on 2015-07-25 11:50:04
         compiled from page.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'page.tpl', 88, false),array('function', 'math', 'page.tpl', 107, false),array('modifier', 'capitalize', 'page.tpl', 101, false),array('modifier', 'replace', 'page.tpl', 119, false),array('modifier', 'normal_text', 'page.tpl', 123, false),array('modifier', 'strip_tags', 'page.tpl', 123, false),array('modifier', 'truncate', 'page.tpl', 123, false),array('modifier', 'date_format', 'page.tpl', 126, false),array('modifier', 'trim', 'page.tpl', 139, false),)), $this); ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/ad_long_horizontal.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
    	...
    	<div class="col-xs-12 col-md-5 db-gutter-right">
			...
			<div class="tenderbox eachbox">
				<p style="font-size: 14px !important;">There are <span class="redhighlight"><?php echo $this->_tpl_vars['jobData']['count']; ?>
</span> jobs in <span class="redhighlight"><?php echo $this->_tpl_vars['jobData']['pages']; ?>
...
"</span></i>.<?php endif; ?></p>
				<?php ob_start(); ?>
				<?php if ($this->_tpl_vars['jobData']['pages'] > 0): ?>
				<div class="pagibox">
					<ul class="pagination pagination-sm">
						<?php if ($this->_tpl_vars['pageNumber'] > 1): ?>
						  <li><a href="/jobs/<?php echo smarty_function_math(array('equation' => "c - p",'c' => $this->_tpl_vars['pageNumber'],'p' => $this->_tpl_vars['one']), $this);?>
"><span class="fa fa-chevron-left"></span></a></li>
						  <?php endif; ?>
						  <?php unset($this->_sections['foo']);
$this->_sections['foo']['name'] = 'foo';
$this->_sections['foo']['start'] = (int)$this->_tpl_vars['pageNumber'];
...
?>
						  <li <?php if ($this->_sections['foo']['iteration'] == $this->_tpl_vars['pageNumber']): ?> class="active" <?php endif; ?>><?php echo $this->_tpl_vars['pageNumber']; ?>
<a href="/jobs/<?php echo $this->_sections['foo']['index']; ?>
"><?php echo $this->_sections['foo']['iteration']; ?>
</a></li>
						 <?php endfor; endif; ?>
						  <?php if ($this->_tpl_vars['pageNumber'] < $this->_tpl_vars['jobData']['pages']): ?>
						  <li><a href="/jobs/<?php echo smarty_function_math(array('equation' => "c + p",'c' => $this->_tpl_vars['pageNumber'],'p' => $this->_tpl_vars['one']), $this);?>
"><span class="fa fa-chevron-right"></span></a></li>
				...
				<?php $_from = $this->_tpl_vars['jobData']['records']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
...
"><?php echo $this->_tpl_vars['item']['job_title']; ?>
 ...
 in <?php echo $this->_tpl_vars['item']['job_area']; ?>
					...
					<dd><span class="bluetxt"><strong><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['job_type'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
</strong></span> - <b><?php echo $this->_tpl_vars['item']['category_name']; ?>
</b></dd>
					<dd class="iconbox">
