<?php /* Smarty version 2.6.20, created on 2015-06-29 15:00:50
         compiled from participants/view/details.tpl */ ?>
 ...
 <?php echo $this->_tpl_vars['participantData']['participant_surname']; ?>
    ...
    <div id="sidetabs">
        <ul >
			...
			<li><a href="<?php if (isset ( $this->_tpl_vars['participantData'] )): ?>/participants/view/cv.php?code=<?php echo $this->_tpl_vars['participantData']['participant_code']; ?>
<?php else: ?>#<?php endif; ?>" title="Details">CV</a></li>
			<li><a href="<?php if (isset ( $this->_tpl_vars['participantData'] )): ?>/participants/view/login.php?code=<?php echo $this->_tpl_vars['participantData']['participant_code']; ?>
<?php else: ?>#<?php endif; ?>" title="Login">Login</a></li>
        </ul>
    </div>
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/participants/view/details.php<?php if (isset ( $this->_tpl_vars['participantData']['participant_code'] )): ?>?code=<?php echo $this->_tpl_vars['participantData']['participant_code']; ?>
