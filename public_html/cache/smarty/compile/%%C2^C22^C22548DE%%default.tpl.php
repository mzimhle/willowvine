<?php /* Smarty version 2.6.20, created on 2015-01-13 10:27:41
         compiled from administration/jobs/application/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'administration/jobs/application/default.tpl', 43, false),)), $this); ?>
...
<script type="text/javascript" language="javascript" src="/administration/jobs/application/default.js"></script>
</head>
...
smarty_core_smarty_include_php(array('smarty_file' => 'administration/includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/administration/jobs/applications/" title="Job Applications">Job Applications</a></li>
        </ul>
	</div><!--breadcrumb-->  
	<div class="inner">     
...
?>
		  <tr>
			...
			<td align="left"><a href="/administration/jobs/application/details.php?code=<?php echo $this->_tpl_vars['item']['enquiry_code']; ?>
...
" target="_blank" class="<?php if ($this->_tpl_vars['item']['_comm_sent'] == 1): ?>success<?php else: ?>error<?php endif; ?>"><?php echo $this->_tpl_vars['item']['_comm_output']; ?>
		  ...
		  <?php endforeach; else: ?>
			<tr>
				<td colspan="5">There are no current applications in the system. </td>
			</tr>
