...
<script type="text/javascript" language="javascript" src="/jobs/jobApplication/default.js"></script>
</head>
...
<div id="container">
  ...
  <div id="content">
	...
	<div class="logged_in">
            <ul>
                <li><a href="/help/enquiries.php" title="Get Help" class="help_icon"> Help</a></li>
	...
	<div id="breadcrumb">
        <ul>
            ...
            <li><a href="/jobs/" title="Users">Jobs</a></li>
			<li><a href="/jobs/jobApplications/" title="Users">jobApplications</a></li>
        </ul>
	</div><!--breadcrumb-->  
	<div class="inner">     
    <h2>Manage Job Applications</h2>		
	<h4>Manage all the Job Applications in the database, view and edit them at will.</h4>	
	<!-- <a href="/users/details.php" title="Click to Add a new User" class="blue_button fr mrg_bot_10"><span style="float:right;">Add a new User</span></a> <br /> -->
    ...
    <div class="clearer"><!-- --></div>
    <div id="tableContent" align="center"><img align="middle" src="/images/ajax-loader.gif" alt="loading" /></div>
    <div class="clearer"><!-- --></div>
    </div><!--inner-->
