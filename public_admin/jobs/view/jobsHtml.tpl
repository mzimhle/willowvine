...
<div class="content_table">
    <form name="enquiriesForm" id="enquiriesForm" action="/jobs/jobsHtml.php" method="post">
    ...
    <table id="grid_table" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td align="left"><a href="/jobs/view/details.php?pk_job_id={$jobItem.pk_job_id}">{$jobItem.job_title}</a></td>	
