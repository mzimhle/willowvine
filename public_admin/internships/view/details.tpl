...
<div id="container">
  ...
  <div id="content">
	...
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/internships/view/details.php{if isset($internshipData.internship_code)}?code={$internshipData.internship_code}{/if}" method="post">
