		...
		<form name="listForm" id="listForm" action="#" method="post">		
			<table id="dataTable" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<td align="left"><a href="/exams/share/details.php?code={$item.share_code}" class="{if $item.share_active eq 1}success{else}error{/if}">{$item.subject_name} - {$item.exam_name}</a></td>
