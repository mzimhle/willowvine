...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'includes/footer.tpl', 18, false),)), $this); ?>
<footer>
	<div class="container">
    	<div class="row">
            <div class="mainfoot cf">
                <div class="col-xs-12 col-md-8">
                    ...
                    <div class="footdis">
                        <p>All rights reserved. &copy; <?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y") : smarty_modifier_date_format($_tmp, "%Y")); ?>
. Willowvine.co.za, its sponsors, contributors and advertisers disclaim all liability for any loss, damage, injury or expense that might arise from the use of, or reliance upon, the services contained herein.</p>
                    </div>
                </div>
...
<div class="modal fade" id="passbox" tabindex="-2" role="dialog" aria-labelledby="Password" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="login-form" role="form" name="footerForgotPasswordForm" id="footerForgotPasswordForm" method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>
">
...
<div class="modal fade" id="jobshare" tabindex="-3" role="dialog" aria-labelledby="JobShare" aria-hidden="true">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="login-form" name="footerJobShareForm" id="footerJobShareForm" role="form" method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>
">
...
<div class="modal fade" id="internshare" tabindex="-3" role="dialog" aria-labelledby="InternShare" aria-hidden="true">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="login-form" name="footerInternShareForm" id="footerInternShareForm" role="form" method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>
">
...
<div class="modal fade" id="careershare" tabindex="-3" role="dialog" aria-labelledby="CareerShare" aria-hidden="true">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="login-form" name="footerCareerShareForm" id="footerCareerShareForm" role="form" method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>
">
...
<div class="modal fade" id="examshare" tabindex="-3" role="dialog" aria-labelledby="ExamShare" aria-hidden="true">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="login-form" name="footerExamShareForm" id="footerExamShareForm" role="form" method="POST" action="<?php echo $_SERVER['REQUEST_URI']; ?>
">
