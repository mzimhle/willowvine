<?php /* Smarty version 2.6.20, created on 2014-12-30 22:21:49
         compiled from administration/exams/share/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'administration/exams/share/default.tpl', 43, false),)), $this); ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'administration/includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/administration/exams/share/" title="View">Share</a></li>
        </ul>
	</div><!--breadcrumb-->  
	<div class="inner">     
    <h2>Manage Exams</h2>		
...
?>
			  <tr>
				...
				<td align="left"><a href="/administration/exams/share/details.php?code=<?php echo $this->_tpl_vars['item']['share_code']; ?>
" class="<?php if ($this->_tpl_vars['item']['share_active'] == 1): ?>success<?php else: ?>error<?php endif; ?>"><?php echo $this->_tpl_vars['item']['subject_name']; ?>
