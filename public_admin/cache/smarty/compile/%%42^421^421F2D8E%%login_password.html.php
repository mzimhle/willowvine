<?php /* Smarty version 2.6.20, created on 2015-01-13 21:28:57
         compiled from templates/mail/login_password.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'templates/mail/login_password.html', 31, false),array('modifier', 'lower', 'templates/mail/login_password.html', 38, false),array('modifier', 'capitalize', 'templates/mail/login_password.html', 38, false),)), $this); ?>
<html>
<head>
...
/templates/mail/images/mail_logo.gif" width="600" height="87" border="0" alt="Willowvine" style="font-family: Helvetica, Verdana, Arial, sans-serif; font-size: 60px; line-height: 0; color: #ef3c3f; font-weight: bold; display: block" /></td>
                ...
                <tr>
                    <td align="left" style="font-size: 20px; font-family: Helvetica, Verdana, Arial, sans-serif; color: #FFFFFF; background-color: #17628c; padding: 15px;" bgcolor="#17628c" colspan="2">
						...
						<span style="font-size: 40px; font-weight: bold;">User log in</span><br />
						<!-- <span style="font-size: 18px; font-weight: bold;">Log in </span> -->
                    </td>
                </tr>
                <tr>
 ...
 <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['mailinglist']['mailinglist_surname'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
						...
						<p>Thank you for registering with us, below are your log in details, you can change your password by loggin into the website and going to your account.</p>
						<p>Username: <b><?php echo $this->_tpl_vars['mailinglist']['participantlogin_username']; ?>
</b></p>
						<p>Password: <b><?php echo $this->_tpl_vars['mailinglist']['participantlogin_password']; ?>
</b></p>
