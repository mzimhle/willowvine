<?php /* Smarty version 2.6.20, created on 2014-12-30 22:54:59
         compiled from templates/mail/share_exam.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'templates/mail/share_exam.html', 31, false),array('modifier', 'upper', 'templates/mail/share_exam.html', 32, false),array('modifier', 'lower', 'templates/mail/share_exam.html', 38, false),array('modifier', 'capitalize', 'templates/mail/share_exam.html', 38, false),)), $this); ?>
<html>
<head>
...
/templates/mail/images/mail_logo.gif" width="600" height="87" border="0" alt="Willowvine" style="font-family: Helvetica, Verdana, Arial, sans-serif; font-size: 60px; line-height: 0; color: #ef3c3f; font-weight: bold; display: block" /></td>
                ...
                <tr>
                    <td align="left" style="font-size: 20px; font-family: Helvetica, Verdana, Arial, sans-serif; color: #FFFFFF; background-color: #17628c; padding: 15px;" bgcolor="#17628c" colspan="2">
						...
						<span style="font-size: 40px; font-weight: bold;"><?php echo ((is_array($_tmp=$this->_tpl_vars['shareData']['share_type'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
 SHARED</span><br />
						<span style="font-size: 18px; font-weight: bold;"><?php echo $this->_tpl_vars['shareData']['career_name']; ?>
</span>
                    </td>
                </tr>
                <tr>
                    <td align="left" style="font-size: 14px; font-family: Helvetica, Verdana, Arial, sans-serif; color: #FFFFFF; background-color: #ef3c3f; padding: 15px;" bgcolor="#ef3c3f" colspan="2">
                    	Good day <b><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['shareData']['share_friendname'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
</b>, your friend <b><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['shareData']['share_name'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
</b> has sent you this message via <b><a href="http://<?php echo $this->_tpl_vars['domain']; ?>
" target="_blank">www.willowvine.co.za</a></b>, it was in order to share the below exam with you:<br />
						<p>The <b><?php echo $this->_tpl_vars['shareData']['exam_name']; ?>
</b> exam with <b><?php echo $this->_tpl_vars['shareData']['subject_name']; ?>
</b> subject, written in <b><?php echo ((is_array($_tmp=$this->_tpl_vars['shareData']['exam_language'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)); ?>
</b>. It was written in <b><?php echo ((is_array($_tmp=$this->_tpl_vars['shareData']['exam_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</b></p>
						<p><b><i>P.S.: You will have to login to be able to download the pdf document of the exam.</i></b></p>
