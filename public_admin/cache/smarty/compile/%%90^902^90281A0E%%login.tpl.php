<?php /* Smarty version 2.6.20, created on 2015-01-30 14:36:36
         compiled from administration/login.tpl */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>WillowVine administration | Login</title>
  	...
  	<div id="login_area">
    	<form id="loginForm" name="loginForm" method="post" target="" action="login.php">
  		<div style="height:100px; width:200px; text-align:left;">
            ...
            <div class="frm-group">
                <div class="frm-input">
                <a href="#" class="button" onclick="if($('#loginForm').valid()) document.forms.loginForm.submit(); "><span>Login</span></a>
            </div>
        </div>
        </form>
		<br />
