<?php /* Smarty version 2.6.20, created on 2015-01-18 09:03:17
         compiled from administration/communication/messages/details.tpl */ ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'administration/includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/administration/communication/messages/" title="Messaages">Messaages</a></li>
			<li>Details</li>
        </ul>
	</div><!--breadcrumb--> 
    ...
    <div id="sidetabs">
        <ul > 
			...
			<li><a href="<?php if (isset ( $this->_tpl_vars['messageData'] )): ?>/administration/communication/messages/comms.php?code=<?php echo $this->_tpl_vars['messageData']['_message_code']; ?>
<?php else: ?>#<?php endif; ?>" title="Comms">Comms</a></li>
        </ul>
    </div><!--tabs-->
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/administration/communication/messages/details.php<?php if (isset ( $this->_tpl_vars['messageData'] )): ?>?code=<?php echo $this->_tpl_vars['messageData']['_message_code']; ?>
...
<?php echo $this->_tpl_vars['messageData']['_message_file']; ?>
	...
	<div class="mrg_top_10">
	  <a class="button cancel mrg_left_147 fl" href="/administration/communication/messages/"><span>Cancel</span></a>
